...
class Controller:
    ...
    def populate_arena(self):
        ...
        # INSTANTIATE BLOCKS (requires map selection)        
        for x, y, form in gen_blocks(self.MAP):
    ...
    def map_screen(self):
        ...
        num1_img_str = 'start_screen//map_1.png'
        num2_img_str = 'start_screen//map_2.png'
        num3_img_str = 'start_screen//map_3.png'
        quit_img_str = 'start_screen//quit.png'
        bkgd_img_str = 'start_screen//start_bg.jpg'
        self.num1 = pygame.image.load(num1_img_str)
        num1_rect = pygame.Rect(327, 230, 125, 50)
